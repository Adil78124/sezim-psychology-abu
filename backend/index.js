...
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY; // Публичный ключ для фронтенда
...
// Endpoint для получения публичной конфигурации Supabase (для фронтенда)
